    ...
    public class IdentityService : IIdentityService
    {
        ...
        public async Task<AuthenticationResult> LoginAsync(string email, string password)
        {
            ...
            if(user == null)
            {
                return new AuthenticationResult
                {
                    Errors = new[] { "Email/Password combination is incorrect." }
                };
            }
        ...
        public async Task<AuthenticationResult> RefreshTokenAsync(string token, string refreshToken)
        {
            ...
            var storedRefreshToken = await _dataContext.RefreshTokens.SingleOrDefaultAsync(
        ...
        private async Task<AuthenticationResult> GenerateAuthResultForUserAsync(IdentityUser user)
        {
            ...
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                ...
                Expires = DateTime.UtcNow.Add(_jwtSettings.TokenLifetime), // 45 sec atm (FOR DEBUG, RAISE TO 5 MIN!)
